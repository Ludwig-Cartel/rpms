...
if(isset($_GET['approved'])){
  $archive = new approval($_GET['rid']);
  $archive->approvedArchived();
}
?>
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav ml-auto">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a id="ddl" class="dropdown-item" href="archives.php"><i class="fa fa-sign-out"></i> Archives</a>
          </div>
        </li>
          <li class="nav-item dropdown">
            <a id="navl1" class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <div class="dropdown-menu" aria-labelledby="navbarDropdown">
            ...
            <a id="ddl" class="dropdown-item" href="archives.php?logout"><i class="fa fa-sign-out"></i> Logout</a>
          </div>
        </li>
        </ul>
      </div>
